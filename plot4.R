...
#Plot four entities on the same page
png(filename = "plot4.png",width = 480,height = 480)
par("mfrow"=c(2,2))
plot(x=data$DateTime,y=data$Global_active_power,type='line',xlab="",ylab="Global Active Power")
plot(x=data$DateTime,y=data$Voltage,type='line',xlab="",ylab="Voltage")
...
plot(x=data$DateTime,y=data$Global_reactive_power,type='line',xlab="",ylab="Global Reactive Power")
